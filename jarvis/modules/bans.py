...
from jarvis import dispatcher, LOGGER, DEV_USERS, SUDO_USERS, TECHY_USERS
...
from jarvis.modules.log_channel import loggable, gloggable
...
def selfunban(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    if user.id not in SUDO_USERS or user.id not in TECHY_USERS:
        return
