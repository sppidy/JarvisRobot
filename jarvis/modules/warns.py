...
from jarvis import dispatcher, BAN_STICKER, WHITELIST_USERS, TECHY_USERS
...
def warn(
    ...
    if num_warns >= limit:
        ...
        message.bot.send_sticker(chat.id, BAN_STICKER)  # Jarvis's sticker
        keyboard = []
        log_reason = (
