...
from jarvis.modules.helper_funcs.chat_status import user_not_admin, user_admin
from jarvis.modules.log_channel import loggable
from jarvis.modules.sql import reporting_sql as sql
from jarvis import dispatcher, LOGGER, SUDO_USERS, TECHY_USERS

REPORT_GROUP = 5
REPORT_IMMUNE_USERS = SUDO_USERS + TECHY_USERS
