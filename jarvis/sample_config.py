...
def get_user_list(config, key):
    with open('{}/jarvis/{}'.format(os.getcwd(), config),
              'r') as json_file:
...
class Config(object):
    ...
    API_HASH = "awoo"
    TOKEN = "BOT_TOKEN"
    OWNER_ID = 1318486004  # If you dont know, run the bot and do /id in your private chat with it
    OWNER_USERNAME = "sppidy"
    START_IMG = "https://telegra.ph/file/62202bce1ce295b6f13bc.png" #Change This To Ur Bot PIC
    ...
    TECHY_USERS = get_user_list('elevated_users.json', 'techy')
